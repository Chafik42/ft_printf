...
/*   Updated: 2021/10/17 23:18:10 by cmarouf          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include <stdio.h>
#include "ft_printf.h"
...
/*int main(void)
  {
  int    a = ft_printf("Hello %d, j'imprime %zzune adresse random %p, je fini par un modulo piege %d et un modulo vide %%%", 42, 42);
  printf("\n");
  int    b = printf("Hello %d, j'imprime %zzune adresse random %p, je fini par un modulo piege %d et un modulo vide %%%", 42, 42);
  printf("\n");
  printf("a = %d <<<< b = %d\n", a, b);
  }*/
